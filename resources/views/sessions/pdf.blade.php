                  ...
                  <table class="exercise-header-table">
                    <tr>
                      ...
                      <td class="exercise-details-cell">
                        <div class="exercise-title">{{ strlen($sessionExercise->custom_exercise_name ?? $exercise->title) > 60 ? substr($sessionExercise->custom_exercise_name ?? $exercise->title, 0,60) . '...' : ($sessionExercise->custom_exercise_name ?? $exercise->title) }}</div>
