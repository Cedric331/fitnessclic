        ...
        <div class="email-wrapper">
            <div class="email-container">
                ...
                <div class="header-gradient">
                    ...
                    <h1 class="header-title">Invitation à rejoindre une équipe</h1>
                    <p class="header-subtitle">Rejoignez votre équipe</p>
                </div>
                ...
                <div class="content">
                    ...
                    <p class="content-text">
                        <strong class="inviter-name">{{ $inviterName }}</strong> vous invite à rejoindre l'équipe <strong class="team-name">{{ $teamName }}</strong> sur FitnessClic.
                    </p>
                    <p class="content-text">
                    ...
                    <div class="cta-section">
                        <a href="{{ $acceptUrl }}" class="cta-button">Voir l'invitation</a>
                    </div>
